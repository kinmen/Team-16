...
for line in sys.stdin:
    ...
    probs = [1,1]
    probs[0] = float(probs_qt_simi[0]*probs_qk_simi[0]*probs_qd_simi[0]*probs_qtk_simi[0]* probs_qtd_simi[0]*probs_qkd_simi[0]*probs_qtkd_simi[0])
    probs[1] = float(probs_qt_simi[1]*probs_qk_simi[1]*probs_qd_simi[1]*probs_qtk_simi[1]* probs_qtd_simi[1]*probs_qkd_simi[1]*probs_qtkd_simi[1])
